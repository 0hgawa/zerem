...
impl Session {
    ...
    fn merge_peer_opts(&self, other: Option<PeerConnectionOptions>) -> PeerConnectionOptions {
        ...
        PeerConnectionOptions {
            ...
            // NOT UPSTREAM -- Zerem. The session decides this, not the torrent:
            // it is a property of the connection somebody is on, and a per-
            // torrent override would be a way to leak in the clear by accident.
            encryption: self.peer_opts.encryption,
        }
    }
